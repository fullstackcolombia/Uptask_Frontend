...
import { TProject, TTaskProject, TTaskStatus } from '@/types/index'
import TaskCard from './TaskCard'
import { statusTranslations } from '@/locales/es'
import DropTask from './DropTask'
import { toast } from 'react-toastify'
import { updatedStatusTask } from '@/api/TaskAPI'
...
export default function TaskList ({ tasks, canEdit }: TaskListProps) {
  ...
  // reduce to group tasks into the state they belong
  ...
  const handleDragEnd = (e: DragEndEvent) => {
    ...
    if (over && over.id) {
      ...
      // setQueryData allow us to add additional data or update it
